-- BuoyNewDangerMarking main entry point.
-- Feature Catalogue Version: 1.0.2 (2022/02/28)

function BuoyNewDangerMarking(feature, featurePortrayal, contextParameters)
  local viewingGroup
  ...
  if feature.PrimitiveType == PrimitiveType.Point then
		...
		featurePortrayal:AddInstructions('PointInstruction:BOYSPP45')
