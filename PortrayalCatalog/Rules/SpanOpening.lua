...
function SpanOpening(feature, featurePortrayal, contextParameters)
    ...
    local clearance = feature.verticalClearanceClosed and feature.verticalClearanceClosed.verticalClearanceValue

    -- If clearance is missing (nil) OR it is <= SafetyHeight, trigger the hazard alert.
    if feature.verticalClearanceClosed.verticalClearanceValue == nil or feature.verticalClearanceClosed.verticalClearanceValue <= contextParameters.SafetyHeight then
