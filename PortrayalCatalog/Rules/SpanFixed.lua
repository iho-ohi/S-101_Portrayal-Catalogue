...
function SpanFixed(feature, featurePortrayal, contextParameters)
    ...
    if feature.verticalClearanceFixed.verticalClearanceValue == nil or feature.verticalClearanceFixed.verticalClearanceValue <= contextParameters.SafetyHeight then
